...
<ul class="nav" id="side-menu">
    ...
    <li <?php if ($url == $base_url . "sale") : ?> class="active" <?php endif ?>><a href="<?php echo $base_url . "sale"; ?>" class="material-ripple"><i class="fa fa-money"></i> Sales</a></li>
    ...
    <li>
        ...
        <ul class="nav nav-second-level">
            ...
            <li><a href="<?php // echo $base_url; 
                            ?>report_company/generate">Company Bill</a></li> -->
        </ul>
    </li>
    <li <?php if (
            $url == $base_url . 'logo' ||
