            ...
            <div class="panel-body">           
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="received_date" id="received_date"  placeholder="<?php echo display('receiveddate'); ?>" class="col-xs-12 col-sm-4  form-control datepicker"/>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="received_from" id="received_from"  placeholder="<?php echo display('receivedfrom'); ?>" class="col-xs-12 col-sm-4 form-control"/>
                        </div>
                ...
                <div id="received_type_cheque" style="display:none">
                    ...
                    <div class="form-group" id="cheque" style="display:none">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix"> 
                                <input type="text" name="account_number" id="account_number"  placeholder="<?php echo display('accountnumber'); ?>" class="col-xs-12 col-sm-4 form-control"/>
                            </div>
