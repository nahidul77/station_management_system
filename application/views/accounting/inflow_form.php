            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="received_date" id="received_date" placeholder="Received Date" class="col-xs-12 col-sm-4  form-control datepicker" />
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="received_from" id="received_from" placeholder="Received From" class="col-xs-12 col-sm-4 form-control" />
                        </div>
