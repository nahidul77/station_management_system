            ...
            <div class="panel-body">           
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="payment_date" id="payment_date"  placeholder="<?php echo display('paymentdate'); ?>" class="col-xs-12 col-sm-4 form-control datepicker"  value="<?php echo set_value('payment_date', $outflow->payment_date); ?>" />
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="payment_to" id="payment_to"  placeholder="<?php echo display('paymentto'); ?>" class="col-xs-12 col-sm-4 form-control"  value="<?php echo set_value('payment_to', $outflow->payment_to); ?>" />
                        </div>
                ...
                <div id="payment_type_cheque" style="display:none">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix"> 
                                <input type="text" name="bank_name" id="bank_name"  placeholder="<?php echo display('bankname'); ?>" class="col-xs-12 col-sm-4 form-control"  value="<?php echo set_value('bank_name', $outflow->bank_name); ?>" />
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix"> 
                                <input type="text" name="branch_name" id="branch_name"  placeholder="<?php echo display('branchname'); ?>" class="col-xs-12 col-sm-4 form-control"  value="<?php echo set_value('branch_name', $outflow->branch_name); ?>" />
                            </div>
                    ...
                    <div class="form-group" id="cheque" style="display:none">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix"> 
                                <input type="text" name="account_number" id="account_number"  placeholder="<?php echo display('accountname'); ?>" class="col-xs-12 col-sm-4 form-control"  value="<?php echo set_value('account_number', $outflow->account_number); ?>" />
                            </div>
                    ...
                    <div class="form-group" id="pay_order" style="display:none">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix"> 
                                <input type="text" name="pay_order_number" id="pay_order_number"  placeholder="<?php echo display('payordernumber'); ?>" class="col-xs-12 col-sm-4 form-control"  value="<?php echo set_value('pay_order_number', $outflow->pay_order_number); ?>" />
                            </div>
                    ...
                    <div class="form-group" id="letterOfCredit" style="display:none">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix"> 
                                <input type="text" name="letter_of_credit" id="letter_of_credit"  placeholder="<?php echo display('lc'); ?>" class="col-xs-12 col-sm-4 form-control"  value="<?php echo set_value('letter_of_credit', $outflow->letter_of_credit); ?>" />
                            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix"> 
                            <input type="text" name="amount" id="amount"  placeholder="<?php echo display('amount'); ?>" class="col-xs-12 col-sm-4 form-control" value="<?php echo set_value('amount', $outflow->amount); ?>" />
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix"> 
                            <textarea name="description" id="description" placeholder="<?php echo display('description'); ?>" class="col-xs-12 col-sm-4 form-control"><?php echo $outflow->description; ?></textarea>    
                        </div>
