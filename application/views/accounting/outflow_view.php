                    ...
                    <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo display('paymentdate'); ?></th>
                                <th><?php echo display('paymentto'); ?></th>
                                <th><?php echo display('paymenttype'); ?></th>
                        ...
                        if (!empty($outflow)):
                            ...
                            foreach ($outflow as $value):
                                ...
                                <tr>
                                    ...
                                    <?php if ($this->session->userdata('user_type') == 9): ?>
                                        <td class="no-print">
                                            <a class="blue" data-toggle="tooltip" title="<?php echo display('view');?>" href="<?php echo base_url() . "accounting/outflow/single_view/" . $value->outflow_id ?>">
                                                <i class="ace-icon fa fa-eye bigger-130"></i>
                                            </a>&nbsp;&nbsp; 
                                            <a class="green" data-toggle="tooltip" title="<?php echo display('edit');?>" href="<?php echo base_url() . "accounting/outflow/edit/" . $value->outflow_id ?>">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>&nbsp;&nbsp; 
                                            <a class="red delete" data-toggle="tooltip" title="<?php echo display('delete');?>" href="<?php echo base_url() . "accounting/outflow/delete/" . $value->outflow_id ?>">
