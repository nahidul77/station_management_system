...
<div class="row">
	<div class="col-xs-12" id="PrintArea">
		<div class="table-header">
			...
			<?php echo display('tripinformation'); ?> 
		</div>
            <hr>
		<div class="col-xs-12 "> 
		<?php 
		...
		$total_advance = 0;
			foreach ($single_trip as $value) { 
				echo "<table class=\"display compact cell-border\" cellspacing=\"0\" width=\"100%\">";
					...
					echo "<th colspan=\"3\">".display('local')."</th></tr>";
					...
					echo "<tr>";
						echo "<th align='left'>".display('rent')."</th>";
		...
		<table id="sample-table-2" class="table display compact cell-border" border='1' cellspacing="0" width="100%" style="margin-top: 3%;">
			<thead>
            ...
            if (!empty($expense_data)) { 
                ...
                echo "<tr><th class=\"text-right\" colspan=\"4\">Grand Total </th><th align='left'>$grand_total</th></tr>"; 
            }
			?>
			</tbody>
			<tfoot>
				<tr class="bg-info">
					...
					<th align='left'><?php echo display('totalexpense');?> = <?php echo (isset($grand_total))?($grand_total):0;?></th>
					<th align='left'></th>
 				</tr>				
			</tfoot>
		</table>  
    ...
    <br/> 
        ...
        <a class="btn btn-sm btn-danger pull-right" href="<?php echo base_url(); ?>trip_local/view_trip_by_trip_link_id/<?php echo (!empty($value->trip_link_id))?$value->trip_link_id:0; ?>/pdf" target="_blank">
