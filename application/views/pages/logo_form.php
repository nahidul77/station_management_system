    ...
    <div class="panel panel-bd">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="d_emergency_cell">Logo</label>
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="d_emergency_cell">Favicon</label>
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix">
