        ...
        <form class="form-horizontal" id="notice-submit" action="<?php echo base_url() . 'trip_local/create'; ?>" method="post">
            ...
            <div class="panel-body">
                ...
                <?php else : ?>
                    ...
                    <input type="hidden" name="import_export" value="0">
                ...
                <div id="trip_expense_list">
                    <legend><?php echo display('tripexpens'); ?></legend>
                    <hr>
                    <table class="table table-striped table-bordered responsive">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <center><?php echo display('expensegroup'); ?></center>
                                </th>
                                <th>
                                    <center><?php echo display('quanity'); ?> </center>
                                </th>
                                <th>
                                    <center><?php echo display('amount'); ?> </center>
                                </th>
                                <th>
                                    <center><?php echo display('total'); ?> </center>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
