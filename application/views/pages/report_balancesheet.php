        ...
        <div class="widget-box">
            <div class="panel-body">
                <div class="widget-header widget-header-blue widget-header-flat">
                    ...
                    <h4 class="widget-title lighter">balancesheet</h4>
                </div>
                <hr>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group" id="date">
                            <label class="control-label col-xs-12 col-sm-3" for="date">date </label>
                    ...
                    <div class="col-md-12" id="PrintArea">
                        <div class="profile-user-info profile-user-info-striped text-right">
                            <div class="profile-info-row">
                                <div class="profile-info-name green">trip</div>
                                <div class="profile-info-value green">contactrate</div>
                                <div class="profile-info-value green">farerate</div>
                                <div class="profile-info-value green">expense</div>
                                <div class="profile-info-value green">Profit1</div>
                                <div class="profile-info-value green">Profit2</div>
                                <div class="profile-info-value green">totalprofit</div>
                            </div>
                            <?php
                            ...
                            <div class="profile-info-row text-right">
                                <div class="profile-info-name purple">total</div>
                            ...
                            <div class="profile-info-row">
                                <div class="profile-info-name green">expense</div>
                                <?php
                                //setting of expense 
                                ...
                                <div class="profile-info-value green">totalexpense</div>
                            </div>
                            <div class="profile-info-row">
                                <div class="profile-info-name purple">total</div>
                                <?php foreach ($expense as $value) : ?>
                            ...
                            <!-- ends of expense  -->
                            <div class="profile-info-row">
                                <div class="profile-info-name green">balance</div>
                                <div class="profile-info-value green">totalprofit</div>
                                <div class="profile-info-value green"></div>
                                <div class="profile-info-value green">totalexpense</div>
                                <div class="profile-info-value green"></div>
                                <div class="profile-info-value green"></div>
                                <div class="profile-info-value green">netbalanceprofit</div>
                            </div>
                            <div class="profile-info-row">
