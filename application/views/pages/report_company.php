                            ...
                            <div class="step-pane active" id="step1">
                                <form name="expense_entry" class="form-horizontal" id="notice-submit" action="<?php echo base_url() . 'report_company/generate/'; ?>" method="post">
                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="company_option">selectanoption</label>
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <select class="col-xs-12 col-sm-4 testselect1" name="company_option" id="company_option">
                                                    <option value="">selectcompanytype</option>
                                                    <option value="1">contactcompany</option>
                                                    <option value="2">otherscompany</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group" id="contact_company" style="display:none">
                                        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="company_id">companyname</label>
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                    ...
                                    <div class="form-group" id="OthersCompany" style="display:none">
                                        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="others_company">othercompany</label>
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <input type="text" id="others_company" name="others_company" value="<?php echo $report->others_company; ?>" placeholder="othercompany" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- #ends of company type# -->
                                    <div class="form-group" id="ImportExport" style="display:none">
                                        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="others_company">exportimport</label>
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <select id="import_export" name="import_export" class="col-xs-12 col-sm-4 testselect1">
                                                    <option value="">exportimportlocal</option>
                                                    <option value="4">local</option>
                                                    <option value="2">export</option>
                                                    <option value="1">import</option>
                                                    <option value="3">exportimport</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="compact cell-border" cellspacing="0" width="40%">
                                            <tr align='left'>
                                                <th style="width:160px;">
                                                    <p style="margin-left:8%;margin-top: 13%;">companyname</p>
                                                </th>
                                                <td><?php
                                            ...
                                            <tr align='left'>
                                                <th>
                                                    <p style="margin-left:8%;">address</p>
                                                </th>
                                                <td><?php
                                            ...
                                            <tr align='left'>
                                                <th>
                                                    <p style="margin-left:8%;">mobileno</p>
                                                </th>
                                                <td><?php
                                            ...
                                            <tr align='left'>
                                                <th>
                                                    <p style="margin-left:8%;">emailaddress</p>
                                                </th>
                                                <td><?php
                                            ...
                                            <tr align='left'>
                                                <th>
                                                    <p style="margin-left:8%;">website</p>
                                                </th>
                                                <td><?php
