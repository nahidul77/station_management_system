                        ...
                        <tr>
                            ...
                            <td>										
                                <div class="clearfix col-xs-12">
                                    <input type="text" name="reg_issue" id=""  placeholder="<?php echo display('registrationdate');?>" class="col-xs-12 datepicker form-control"/>
                                </div>										
                            </td>
                            <td>										
                                <div class="clearfix col-xs-12">
                                    <input type="text" name="reg_expire" id=""  placeholder="<?php echo display('registrationdate');?>" class="col-xs-12 datepicker form-control"/>
                                </div>								
                            </td>
                        </tr>
                        <tr>								
                            ...
                            <td>										
                                <div class="clearfix col-xs-12 ">
                                    <input type="text" name="fitness_issue" id=""  placeholder="<?php echo display('fitnessdate');?>" class="col-xs-12 datepicker form-control"/>							
                                </div>										
                            </td>
                            <td>										
                                <div class="clearfix col-xs-12">
                                    <input type="text" name="fitness_expire" id=""  placeholder="<?php echo display('fitnessdate');?>" class="col-xs-12 datepicker form-control"/>										
                                </div>										
                            </td>
                        </tr>
                        <tr>								
                            ...
                            <td>								
                                <div class="clearfix col-xs-12 ">
                                    <input type="text" name="insurance_issue" id=""  placeholder="<?php echo display('insurancedate');?>" class="col-xs-12 datepicker form-control"/>																		
                                </div>
                            </td>
                            <td>										
                                <div class="clearfix col-xs-12">
                                    <input type="text" name="insurance_expire" id=""  placeholder="<?php echo display('insurancedate');?>" class="col-xs-12  datepicker form-control"/>										
                                </div>									
                            </td>
                        </tr>
                        <tr>								
                            ...
                            <td>								
                                <div class="clearfix col-xs-12 ">
                                    <input type="text" name="tax_issue" id=""  placeholder="<?php echo display('taxtokendate');?>" class="col-xs-12 datepicker form-control"/>																		
                                </div>
                            </td>
                            <td>										
                                <div class="clearfix col-xs-12">
                                    <input type="text" name="tax_expire" id=""  placeholder="<?php echo display('taxtokendate');?>" class="col-xs-12 datepicker form-control"/>										
                                </div>									
                            </td>
                        </tr>
                        <tr>								
                            ...
                            <td>								
                                <div class="clearfix col-xs-12 ">
                                    <input type="text" name="root_permit_issue" id=""  placeholder="<?php echo display('rootpermitdate');?>" class="col-xs-12 datepicker form-control"/>																		
                                </div>
                            </td>
                            <td>										
                                <div class="clearfix col-xs-12">
                                    <input type="text" name="root_permit_expire" id=""  placeholder="<?php echo display('rootpermitdate');?>" class="col-xs-12 datepicker form-control"/>										
                                </div>									
                            </td>
                        </tr>
                        <!--<tr>-->
