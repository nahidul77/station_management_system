...
class Driver_info extends CI_Controller
{
    ...
    public function create()
    {
        ...
        $data['informations'] = (object) array(
            'driver_id' => '', 'driver_name' => '', 'v_registration_no' => '', 'd_license_no' => '',
    ...
    public function save()
    {
        ...
        $this->form_validation->set_rules('d_mobile', 'Mobile No', 'trim|required');
        $this->form_validation->set_rules('v_registration_no', 'Vehicle Registration No', 'trim|required');
        $this->form_validation->set_rules('d_license_no', 'License Number', 'trim|required');
        $this->form_validation->set_rules('d_address_permanent', 'Permanent Address', 'trim|required');
